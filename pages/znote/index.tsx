...
export default function IndexPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('znotePosts')
    if (saved) {
  ...
  const handleDelete = (id: number) => {
    ...
    setPosts(updated)
    localStorage.setItem('znotePosts', JSON.stringify(updated))
  }

  return (
    <div style={ backgroundColor: '#fdfaf5', minHeight: '100vh', padding: '2rem', fontFamily: 'sans-serif' }>
      <h1 style={ fontSize: '1.5rem', color: '#a78bfa' }>ZNOTE 게시판</h1>

      <div style={ marginBottom: '1rem' }>
        <Link href="/znote/write" style={
