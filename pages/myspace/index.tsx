...
export default function IndexPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('myspacePosts')
    if (saved) {
  ...
  const handleDelete = (id: number) => {
    ...
    setPosts(updated)
    localStorage.setItem('myspacePosts', JSON.stringify(updated))
  }

  return (
    <div style={ backgroundColor: '#fdfaf5', minHeight: '100vh', padding: '2rem', fontFamily: 'sans-serif' }>
      <h1 style={ fontSize: '1.5rem', color: '#a78bfa' }>MYSPACE 게시판</h1>

      <div style={ marginBottom: '1rem' }>
        <Link href="/myspace/write" style={
