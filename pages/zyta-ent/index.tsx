...
export default function IndexPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('zyta-entPosts')
    if (saved) {
  ...
  const handleDelete = (id: number) => {
    ...
    setPosts(updated)
    localStorage.setItem('zyta-entPosts', JSON.stringify(updated))
  }

  return (
    <div style={ backgroundColor: '#fdfaf5', minHeight: '100vh', padding: '2rem', fontFamily: 'sans-serif' }>
      <h1 style={ fontSize: '1.5rem', color: '#a78bfa' }>ZYTA ENT 게시판</h1>

      <div style={ marginBottom: '1rem' }>
        <Link href="/zyta-ent/write" style={
